...
! function(a, b, c, d) {
    ...
    a.extend(e.prototype, {
        ...
        _sliderMarkup: function() {
            ...
            }).appendTo(b.nav)), (b.controls || b.navPagination) && b.nav.appendTo(b.$obj), b._updateSliderPagination(), b.options.auto && (b.options.autoPauseOnHover && (b.mouseIsEntered = !1, b.$obj.on("mouseenter.cbp", function() {
        ...
        _gridLayout: function() {
            var b = this;
            b.blocksOn.each(function(c, d) {
                var e, f, g, h, i = Math.min.apply(Math, b.colVert),
                    j = 0,
                    k = a(d).data("cbp");
        ...
        _addItems: function(b, c) {
            var d = this,
                f = a(b).filter(".cbp-item").addClass("cbp-loading-fadeIn").css("top", "1000%").wrapInner('<div class="cbp-item-wrapper"></div>');
...
function(a, b, c) {
    ...
    function(a) {
        ...
        function b(b) {
            var d = this;
            d.parent = b, b._registerEvent("initFinish", function() {
                b.$obj.on("click.cbp", ".cbp-caption-defaultWrap", function(d) {
                    if (d.preventDefault(), !b.isAnimating) {
                        ...
                        if (b.$obj.addClass("cbp-caption-expand-active"), g.hasClass("cbp-caption-expand-open")) {
                            var j = i;
                            i = h, h = j, g.removeClass("cbp-caption-expand-open")
                        }
                        f.css(h), b._gridAdjust(), b._layout(), b.positionateItems(), b._resizeMainContainer(), f.css(i), requestAnimationFrame(function() {
                            g.addClass("cbp-caption-expand-open"), f.one(c.Private.transitionend, function() {
                            ...
                            }), f.css(h), "slider" === b.options.layoutMode && b._updateSlider(), b._triggerEvent("resizeGrid")
                        })
                    }
                })
            }, !0)
    ...
    function(a) {
        ...
        c.Plugins.BottomToTop = function(a) {
            return c.Private.modernBrowser && "bottomToTop" === a.options.displayType && 0 !== a.blocks.length ? new b(a) : null
        }
    }(jQuery, window, document),
    function(a) {
        "use strict";
        ...
        c.Plugins.FadeInToTop = function(a) {
            return c.Private.modernBrowser && "fadeInToTop" === a.options.displayType && 0 !== a.blocks.length ? new b(a) : null
        }
    }(jQuery, window, document),
    function(a) {
        "use strict";
        ...
        c.Plugins.LazyLoading = function(a) {
            return !c.Private.modernBrowser || "lazyLoading" !== a.options.displayType && "fadeIn" !== a.options.displayType || 0 === a.blocks.length ? null : new b(a)
        }
    }(jQuery, window, document),
    function(a) {
        "use strict";
        ...
        c.Plugins.DisplaySequentially = function(a) {
            return c.Private.modernBrowser && "sequentially" === a.options.displayType && 0 !== a.blocks.length ? new b(a) : null
        }
    }(jQuery, window, document);